...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    try {
        ...
        $sql = "INSERT INTO despesas (descricao, valor, data, empresa_id, categoria_id) VALUES (?, ?, ?, ?, ?)";
            ...
            <div class="w-full max-w-md">
                ...
                <form method="POST" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="valor" step="0.01" min="0.01" required placeholder="Ex: 50.75"
