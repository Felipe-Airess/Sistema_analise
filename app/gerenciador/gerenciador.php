            ...
            <div class="grafico flex grid grid-cols-3 gap-6">
                ...
                <div class="grafico col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="grafico col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border-l-4 <?= $lucro_total >= 0 ? 'border-green-500' : 'border-red-500' ?> transition-colors duration-500">
                        <h4 class="font-['Poppins'] text-md text-gray-600 dark:text-gray-300 font-semibold mb-2 flex items-center gap-2">
                            <i class="fas fa-chart-line <?= $lucro_total >= 0 ? 'text-green-500' : 'text-red-500' ?>"></i> Lucro Total
                        </h4>
                    ...
                    <div class="grafico col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border-l-4 border-blue-500 transition-colors duration-500">
                        <h4 class="font-['Poppins'] text-md text-gray-600 dark:text-gray-300 font-semibold mb-2 flex items-center gap-2">
                            <i class="fas fa-arrow-up text-blue-500"></i> Total de Receitas
                        </h4>
                    ...
                    <div class="grafico col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border-l-4 border-red-500 transition-colors duration-500">
                        <h4 class="font-['Poppins'] text-md text-gray-600 dark:text-gray-300 font-semibold mb-2 flex items-center gap-2">
                            <i class="fas fa-arrow-down text-red-500"></i> Total de Despesas
                        </h4>
                ...
                <div class="grafico col-span-3 lg:col-span-2 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md transition-colors duration-500">
                    <h4 class="font-['Poppins'] text-md text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-chart-line text-blue-500"></i> Evolução Mensal das Receitas
                    </h4>
                ...
                <div class="grafico col-span-3 lg:col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md transition-colors duration-500">
                    <h4 class="font-['Poppins'] text-md text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-pie-chart text-purple-500"></i> Lucro por Categoria
                    </h4>
                    <div style="position: relative; height: 300px; width: 100%;">
                ...
                <div class="grafico col-span-3 lg:col-span-2 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md transition-colors duration-500">
                    <h4 class="font-['Poppins'] text-md text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-chart-bar text-green-500"></i> Lucro Mensal
                    </h4>
                    <div style="position: relative; height: 300px; width: 100%;">
                ...
                <div class="grafico col-span-3 lg:col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md transition-colors duration-500">
                    <h4 class="font-['Poppins'] text-md text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-balance-scale text-orange-500"></i> Receitas vs Despesas
                    </h4>
                    <div style="position: relative; height: 300px; width: 100%;">
                ...
                <div class="col-span-3 mt-4">
                    <h3 class="font-['Poppins'] text-lg text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-plus-circle text-green-500"></i> Últimas Receitas Adicionadas
                    </h3>
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow-md">
                            <thead>
                                <tr>
                                    <th class="py-3 px-6 bg-gray-200 dark:bg-gray-700 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Descrição</th>
                                    <th class="py-3 px-6 bg-gray-200 dark:bg-gray-700 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Categoria</th>
                                    <th class="py-3 px-6 bg-gray-200 dark:bg-gray-700 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Valor</th>
                                    <th class="py-3 px-6 bg-gray-200 dark:bg-gray-700 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Data</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($ultimas_receitas as $receita): ?>
                                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td class="py-4 px-6 text-sm text-gray-700 dark:text-gray-300"><?= htmlspecialchars($receita['descricao']); ?></td>
                                        <td class="py-4 px-6 text-sm text-gray-700 dark:text-gray-300"><?= htmlspecialchars($receita['categoria_nome']); ?></td>
                                        <td class="py-4 px-6 text-sm text-green-600 font-semibold">R$ <?= number_format($receita['valor'], 2, ',', '.'); ?></td>
                                        <td class="py-4 px-6 text-sm text-gray-700 dark:text-gray-300"><?= date('d/m/Y', strtotime($receita['data'])); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                ...
                <div class="col-span-3 mt-4">
                    <h3 class="font-['Poppins'] text-lg text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-minus-circle text-red-500"></i> Últimas Despesas Adicionadas
                    </h3>
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow-md">
                            <thead>
                            ...
                            <tbody>
                                <?php foreach ($ultimas_despesas as $despesa): ?>
                                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td class="py-4 px-6 text-sm text-gray-700 dark:text-gray-300"><?= htmlspecialchars($despesa['descricao']); ?></td>
                                        <td class="py-4 px-6 text-sm text-gray-700 dark:text-gray-300"><?= htmlspecialchars($despesa['categoria_nome']); ?></td>
                                        <td class="py-4 px-6 text-sm text-red-600 font-semibold">R$ <?= number_format($despesa['valor'], 2, ',', '.'); ?></td>
                                        <td class="py-4 px-6 text-sm text-gray-700 dark:text-gray-300"><?= date('d/m/Y', strtotime($despesa['data'])); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                ...
                <div class="col-span-3 lg:col-span-2 bg-white dark:bg-gray-800 px-4 py-6 rounded-lg shadow-md transition-colors duration-500">
                    <h4 class="font-['Poppins'] text-md text-[#004b8d] dark:text-gray-100 font-semibold mb-4 flex items-center gap-2">
                        <i class="fas fa-chart-area text-teal-500"></i> Lucro Trimestre
                    </h4>
                    <div style="position: relative; height: 300px; width: 100%;">
                ...
                <div class="col-span-3 lg:col-span-1 bg-white flex flex-col justify-center gap-4 rounded-lg items-center p-6 dark:bg-gray-800 shadow-md">
                    <h2 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-2 flex items-center gap-2">
                        <i class="fas fa-rocket text-blue-600"></i> Ações Rápidas
                    </h2>
                    <a href="exportar_pdf.php" class="flex items-center justify-center gap-2 bg-[#004b8d] w-full hover:bg-[#003366] text-white px-4 py-3 rounded-lg transition-all hover:scale-105">
                        <i class="fas fa-file-pdf"></i> Gerar Relatório 
                    </a>
                    <button id="exportar_graficos" class="flex items-center justify-center gap-2 bg-[#004b8d] w-full hover:bg-[#003366] text-white px-4 py-3 rounded-lg transition-all hover:scale-105">
