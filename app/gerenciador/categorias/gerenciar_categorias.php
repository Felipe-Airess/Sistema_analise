...
<body class="flex min-h-screen flex-col bg-gray-100 dark:bg-gray-900 transition-colors duration-500">
    <main class="flex flex-row gap-6 max-h-screen max-sm:flex-col">
        <aside
            ...
            <nav
                class="sm:hidden flex flex-row items-center justify-between w-full text-sm text-white font-['Poppins'] px-4 relative">
                ...
                <div id="mobileMenuDropdown" class="hidden absolute top-full left-0 right-0 bg-gradient-to-r from-blue-500 to-blue-700 shadow-lg z-40 flex flex-col min-w-full">
                    <a href="../gerenciador.php"
                        class="p-3 flex items-center gap-2 border-b border-white/10 <?= basename($_SERVER['PHP_SELF']) == 'gerenciador.php' ? 'bg-white/20' : 'hover:bg-white/10' ?>">
                        <i class="fas fa-home"></i> Inicio
                    </a>
                    <a href="../despesas/gerenciar_despesas.php"
                        class="p-3 flex items-center gap-2 border-b border-white/10 <?= basename($_SERVER['PHP_SELF']) == 'gerenciar_despesas.php' ? 'bg-white/20' : 'hover:bg-white/10' ?>">
                        <i class="fas fa-arrow-down"></i> Despesas
                    </a>
                    <a href="../receitas/gerenciar_receitas.php"
                        class="p-3 flex items-center gap-2 border-b border-white/10 <?= basename($_SERVER['PHP_SELF']) == 'gerenciar_receitas.php' ? 'bg-white/20' : 'hover:bg-white/10' ?>">
                        <i class="fas fa-arrow-up"></i> Receitas
                    </a>
                    <a href="gerenciar_categorias.php"
                        class="p-3 flex items-center gap-2 border-b border-white/10 <?= basename($_SERVER['PHP_SELF']) == 'gerenciar_categorias.php' ? 'bg-white/20' : 'hover:bg-white/10' ?>">
                        <i class="fas fa-tags"></i> Categorias
                    </a>
                    <a href="../metas/gerenciar_metas.php"
                        class="p-3 flex items-center gap-2 border-b border-white/10 <?= basename($_SERVER['PHP_SELF']) == 'gerenciar_metas.php' ? 'bg-white/20' : 'hover:bg-white/10' ?>">
                        <i class="fas fa-bullseye"></i> Metas
                    </a>
                    <button id="openSettingsModalSm"
                        class="p-3 flex items-center gap-2 border-b border-white/10 hover:bg-white/10 text-left w-full">
                        <i class="fas fa-cog"></i> Configurações
                    </button>
                    <a href="../../login/logout.php"
                        class="p-3 flex items-center gap-2 hover:bg-red-600">
